...
mask_a = muller.in_a(points)
mask_b = muller.in_b(points)

b_vec = -np.ones(N_short**2)
...
x1 = X[:-1, :-1]
y1 = Y[:-1, :-1]
u1 = np.reshape(muller.potential(
