...
while True:
    ...
    filename = f'./o_{itr+100}/simulation_input.txt'
    itr_path = f'./o_{itr+100}'
    long_C7ax_path_itr = f'./o_{itr+100}/long_C7ax_{l}'
    long_C7eq_path_itr = f'./o_{itr+100}/long_C7eq_{l}'
...
em_C7ax.tpr plumed_C7ax_{l}.dat {model_file} {l} COLVAR_{l} {long_C7ax_path_itr}'''
    ...
    draw_q0_dq0(q,360,data_biased_itr,figname_q0,filename_dq0,device=device)
