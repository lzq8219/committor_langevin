...
logging.basicConfig(
    filename=f'muller_potential/log/gamma{gamma}_kbt{kbt}_pinn.log',        # Specify the log file name
...
model_file = f'./muller_potential/model/gamma{gamma}_kbt{kbt}_pinn.pth'
config_file = f'./muller_potential/config/gamma{gamma}_kbt{kbt}_pinn.txt'
...
'''
loss_list,b_loss_list,tot_loss_list=train_pinn(model=q,
                                          data=data,
                                          w=w,
...
# Adjust layout  
plt.savefig(f'muller_potential/fig/loss_gamma{gamma}_kbt{kbt}_subtrain_{subtrain_idx}_pinn.png',dpi = 300, bbox_inches='tight')
model_file = f'./muller_potential/model/gamma{gamma}_kbt{kbt}_subtrain_{subtrain_idx}_pinn.pth'
config_file = f'./muller_potential/config/gamma{gamma}_kbt{kbt}_subtrain_{subtrain_idx}_pinn.txt'
...
plt.ylabel('x2')
plt.colorbar()
plt.savefig(f'muller_potential/fig/sampling_gamma{gamma}_kbt{kbt}_subtrain_{subtrain_idx}_pinn.png',dpi = 300, bbox_inches='tight')
...
# Adjust layout  
plt.savefig(f'muller_potential/fig/loss_gamma{gamma}_kbt{kbt}_total_pinn.png',dpi = 300, bbox_inches='tight') 
model_file = f'./muller_potential/model/gamma{gamma}_kbt{kbt}_pinn.pth'
config_file = f'./muller_potential/config/gamma{gamma}_kbt{kbt}_pinn.txt'
save_model(q,model_file,config_file)
...
plt.ylabel('x2')
plt.colorbar()
plt.savefig(f'muller_potential/fig/ave_muller_potential_gamma{gamma}_kbt{kbt}_pinn.png',dpi = 300, bbox_inches='tight')
...
plt.savefig(f'muller_potential/fig/simulation_gamma{gamma}_kbt{kbt}_pinn.png',dpi = 300, bbox_inches='tight')
...
plt.savefig(f'muller_potential/fig/NN_gamma{gamma}_kbt{kbt}_pinn.png',dpi = 300, bbox_inches='tight')
...
plt.savefig(f'muller_potential/fig/error_gamma{gamma}_kbt{kbt}_pinn.png',dpi = 300, bbox_inches='tight')
...
plt.savefig(f'muller_potential/fig/pinn_gamma{gamma}_kbt{kbt}_pinn.png',dpi = 300, bbox_inches='tight')
...
plt.ylabel('x2')
plt.colorbar()
plt.savefig(f'muller_potential/fig/ave_error_gamma{gamma}_kbt{kbt}_pinn.png',dpi = 300, bbox_inches='tight')
